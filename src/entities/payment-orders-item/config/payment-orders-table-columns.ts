...
export const getPaymentOrdersTableColumns = (router: Router, contextMenuItems: Array<Record<string, any>> = []) => [
  {
    title: 'Банк',
    field: `${PaymentOrderKey.paymentOrder}.${PaymentOrderKey.bankLight}`,
  ...
  },
  {
    ...
    formatter: (cell) => LinkFormatter({
      to: { path: _paths.ORDERS_FORM, params: { exKey: (cell.getData() as Record<string, any>).exKey } },
  ...
  {
    title: PaymentOrdersVocabulary[PaymentOrderKey.code],
    field: `${PaymentOrderKey.paymentOrder}.${PaymentOrderKey.paymentInfo}.${PaymentOrderKey.code}`,
  ...
  },
  {
    ...
    columns: [
      ...
      {
        title: PaymentOrdersVocabulary[PaymentOrderKey.payerPersonalAccount],
        field: `${PaymentOrderKey.paymentOrder}.${PaymentOrderKey.payer}.${PaymentOrderKey.payerPersonalAccount}`,
        width: 130,
      },
      {
  ...
  {
    title: PaymentOrdersVocabulary[PaymentOrderKey.primaryDocShortName],
    field: `${PaymentOrderKey.paymentOrder}.${PaymentOrderKey.additionalInformation}.${PaymentOrderKey.primaryDocShortName}`,
    width: 200,
  },
  {
    title: '',
